 ...
 */
@RestController
@RequestMapping("/children/course")
public class DCourseController extends ChildrenBaseController{

    @Autowired
    private DCourseService dCourseService;


    @PostMapping("/findByPage")
    public Result findByPage(@RequestBody JSONObject jsonObject) throws IllegalAccessException {
        Page<DCourse> pageData = dCourseService.findByPage(jsonObject);
