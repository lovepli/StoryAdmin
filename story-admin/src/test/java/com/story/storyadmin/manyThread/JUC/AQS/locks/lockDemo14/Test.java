...
public class Test {
    ...
    public void test() throws ExecutionException, InterruptedException {
        ...
        final  Lock lock = new ReentrantLock();//设置 lock 锁
         threadPoolTaskExecutor.execute(new LockRunnable1(lockDemo,lock));
         threadPoolTaskExecutor.execute(new LockRunnable2(lockDemo,lock));
