package com.story.storyadmin.manyThread.threadLocalDemo7.demo5;
...
//其实这也是一种思路，但是在并发环境下，如果要使用Map，那么就需要使用同步的Map，比如ConcurrentHashMap或者Collections.SynchronizedMap()，
// 前者底层用的是CAS和锁机制，后者直接使用的是synchronized，性能也不尽人意。
