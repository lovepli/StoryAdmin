package com.story.storyadmin.manyThread.JUC.AQS.locks.ReentrantReadWriteLock;
...
/**
 * @author: lipan
 * @date: 2021年08月25日 3:12 下午
 * @description: ReentrantReadWriteLock 就是共享锁的实现方式，它允许一个线程进行写操作，允许多个线程读操作。
 */
