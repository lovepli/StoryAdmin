...
public class Test {
    ...
    public void test() throws ExecutionException, InterruptedException {
        ...
        threadPoolTaskExecutor.execute(new DeadLockRunnable1(semaphoreDemo1,lock));
        threadPoolTaskExecutor.execute(new DeadLockRunnable2(semaphoreDemo1,semaphoreDemo2,lock));
