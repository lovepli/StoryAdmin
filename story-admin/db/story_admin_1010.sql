...
-- ----------------------------
INSERT INTO `st_image_file` VALUES ('1', '20201010153711_Snipaste_2020-09-10_15-38-22.png', 'D:/fileUpload/20201010153711_Snipaste_2020-09-10_15-38-22.png', 'http://localhost:8080/images/20201010153711_Snipaste_2020-09-10_15-38-22.png');
INSERT INTO `st_image_file` VALUES ('2', '20201010154757_15.面试题：两数之和.mp4', 'D:/fileUpload/20201010154757_15.面试题：两数之和.mp4', 'http://localhost:8080/images/20201010154757_15.面试题：两数之和.mp4');
...
CREATE TABLE `st_login_log` (
  ...
  `modified_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=284 DEFAULT CHARSET=utf8 COLLATE=utf8_bin ROW_FORMAT=DYNAMIC COMMENT='登录日志';
...
CREATE TABLE `st_role` (
  ...
  `modified_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COLLATE=utf8_bin ROW_FORMAT=DYNAMIC COMMENT='角色表';
...
CREATE TABLE `st_role_authority` (
  ...
  `modified_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1088 DEFAULT CHARSET=utf8 COLLATE=utf8_bin ROW_FORMAT=DYNAMIC COMMENT='角色权限关系表';
...
CREATE TABLE `st_user` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COLLATE=utf8_bin ROW_FORMAT=DYNAMIC COMMENT='用户表';

-- ----------------------------
-- Records of st_user
-- ----------------------------
INSERT INTO `st_user` VALUES ('1', '管理员', 'admin', 'bcd0b29f69059fe4c69802525c4ab550', 'https://wpimg.wallstcn.com/f778738c-e4f8-4870-b634-56703b4acafe.gif', 'admin@admin.admin', '2019-01-17 15:05:04', '1', '1', null, 'admin', '2018-12-29 10:40:07', '2020-10-09 02:50:21', '0');
INSERT INTO `st_user` VALUES ('2', 'sunnj01', 'njsun', '0ace0a5fc5802a43305c8ae547a81afe', 'https://wpimg.wallstcn.com/f778738c-e4f8-4870-b634-56703b4acafe.gif', 'aa@aa.aa2', '2019-01-17 15:25:42', '0', '1', null, null, null, '2020-10-09 03:01:48', '0');
INSERT INTO `st_user` VALUES ('4', '测试', 'test', '0ace0a5fc5802a43305c8ae547a81afe', 'http://localhost:9428/null/download/20200914154355914_.png', 'test@aa.aa', '2019-01-17 15:23:28', '1', '1', null, null, null, '2020-10-09 03:24:33', '0');
INSERT INTO `st_user` VALUES ('8', 'lipan', 'lovepli', 'a4e24a4d31f8c8aee8cf346945b0890c', '', 'pli38546@gmail.com', '2020-08-18 04:30:37', '1', '0', 'admin', 'admin', '2020-08-18 04:30:37', '2020-08-18 06:42:28', '0');
...
CREATE TABLE `st_user_role` (
  ...
  `modified_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8 COLLATE=utf8_bin ROW_FORMAT=DYNAMIC COMMENT='用户角色关系表';
