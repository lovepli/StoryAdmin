...
CREATE TABLE `st_dept` (
  ...
  `dept_desc` varchar(200) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL COMMENT '部门描述',
  `yn_flag` char(2) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL COMMENT '有效标志',
  `creator` varchar(32) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  `editor` varchar(32) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
