...
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='附件表';
...
CREATE TABLE `st_login_log` (
  ...
  `modified_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=283 DEFAULT CHARSET=utf8 COLLATE=utf8_bin ROW_FORMAT=DYNAMIC COMMENT='登录日志';
...
INSERT INTO `st_user` VALUES ('2', 'sunnj01', 'njsun', '0ace0a5fc5802a43305c8ae547a81afe', '', 'aa@aa.aa2', '2019-01-17 15:25:42', '0', '1', null, null, null, '2019-01-17 15:25:42', '0');
INSERT INTO `st_user` VALUES ('4', '测试', 'test', '0ace0a5fc5802a43305c8ae547a81afe', '', 'test@aa.aa', '2019-01-17 15:23:28', '1', '1', null, null, null, '2019-01-17 15:23:28', '0');
