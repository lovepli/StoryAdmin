...
CREATE TABLE `st_authority` (
  ...
  `modified_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=136 DEFAULT CHARSET=utf8 COLLATE=utf8_bin ROW_FORMAT=DYNAMIC COMMENT='权限表';
...
INSERT INTO `st_authority` VALUES ('132', '展开表格', 'test.expandtable.list', '0-123', null, '3', '123', '1', 'admin', 'admin', '2020-10-27 08:29:07', '2020-10-27 08:29:07');
...
CREATE TABLE `st_login_log` (
  ...
  `modified_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=345 DEFAULT CHARSET=utf8 COLLATE=utf8_bin ROW_FORMAT=DYNAMIC COMMENT='登录日志';
...
INSERT INTO `st_login_log` VALUES ('330', 'admin', '2020-10-27 02:08:55', '登录成功', '1', 'admin', 'admin', '2020-10-27 02:08:55', '2020-10-27 02:08:54');
INSERT INTO `st_login_log` VALUES ('331', 'admin', '2020-10-27 02:11:13', '登录成功', '1', 'admin', 'admin', '2020-10-27 02:11:13', '2020-10-27 02:11:13');
INSERT INTO `st_login_log` VALUES ('332', 'admin', '2020-10-27 02:22:33', '登录成功', '1', 'admin', 'admin', '2020-10-27 02:22:33', '2020-10-27 02:22:33');
INSERT INTO `st_login_log` VALUES ('333', 'admin', '2020-10-27 02:36:00', '登录成功', '1', 'admin', 'admin', '2020-10-27 02:36:00', '2020-10-27 02:35:59');
INSERT INTO `st_login_log` VALUES ('334', 'admin', '2020-10-27 02:42:36', '登录成功', '1', 'admin', 'admin', '2020-10-27 02:42:36', '2020-10-27 02:42:36');
INSERT INTO `st_login_log` VALUES ('335', 'admin', '2020-10-27 03:35:54', '登录成功', '1', 'admin', 'admin', '2020-10-27 03:35:54', '2020-10-27 03:35:54');
INSERT INTO `st_login_log` VALUES ('336', 'admin', '2020-10-27 03:45:29', '登录成功', '1', 'admin', 'admin', '2020-10-27 03:45:29', '2020-10-27 03:45:29');
INSERT INTO `st_login_log` VALUES ('337', 'admin', '2020-10-27 06:42:55', '登录成功', '1', 'admin', 'admin', '2020-10-27 06:42:55', '2020-10-27 06:42:54');
INSERT INTO `st_login_log` VALUES ('338', 'admin', '2020-10-27 06:58:36', '登录成功', '1', 'admin', 'admin', '2020-10-27 06:58:36', '2020-10-27 06:58:36');
INSERT INTO `st_login_log` VALUES ('339', 'admin', '2020-10-27 07:44:03', '登录成功', '1', 'admin', 'admin', '2020-10-27 07:44:03', '2020-10-27 07:44:03');
INSERT INTO `st_login_log` VALUES ('340', 'admin', '2020-10-27 07:47:07', '登录成功', '1', 'admin', 'admin', '2020-10-27 07:47:07', '2020-10-27 07:47:06');
INSERT INTO `st_login_log` VALUES ('341', 'admin', '2020-10-27 07:54:45', '登录成功', '1', 'admin', 'admin', '2020-10-27 07:54:45', '2020-10-27 07:54:45');
INSERT INTO `st_login_log` VALUES ('342', 'admin', '2020-10-27 07:56:04', '登录成功', '1', 'admin', 'admin', '2020-10-27 07:56:04', '2020-10-27 07:56:04');
INSERT INTO `st_login_log` VALUES ('343', 'admin', '2020-10-27 08:28:49', '登录成功', '1', 'admin', 'admin', '2020-10-27 08:28:49', '2020-10-27 08:28:49');
INSERT INTO `st_login_log` VALUES ('344', 'admin', '2020-10-27 08:33:24', '登录成功', '1', 'admin', 'admin', '2020-10-27 08:33:24', '2020-10-27 08:33:24');
...
CREATE TABLE `st_resource` (
  ...
  `modified_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=34 DEFAULT CHARSET=utf8 COLLATE=utf8_bin ROW_FORMAT=DYNAMIC COMMENT='菜单表';
...
INSERT INTO `st_resource` VALUES ('17', '服务监控', '0', 'nested', '39', '/monitor', '/layout/Layout', '1', '0', null, '1', 'admin', 'admin', '2020-08-21 07:52:18', '2020-10-27 06:55:01');
...
INSERT INTO `st_resource` VALUES ('21', '日志管理', '0-1', 'documentation', '38', 'log', '/layout/Layout', '1', '1', null, '1', 'admin', 'admin', '2020-08-21 08:47:00', '2020-10-27 06:54:43');
...
CREATE TABLE `st_role_authority` (
  ...
  `modified_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=2151 DEFAULT CHARSET=utf8 COLLATE=utf8_bin ROW_FORMAT=DYNAMIC COMMENT='角色权限关系表';
...
INSERT INTO `st_role_authority` VALUES ('2099', '1', '0', '1', 'admin', 'admin', '2020-10-27 08:33:16', '2020-10-27 08:33:16');
INSERT INTO `st_role_authority` VALUES ('2100', '1', '128', '1', 'admin', 'admin', '2020-10-27 08:33:16', '2020-10-27 08:33:16');
INSERT INTO `st_role_authority` VALUES ('2101', '1', '1', '1', 'admin', 'admin', '2020-10-27 08:33:16', '2020-10-27 08:33:16');
INSERT INTO `st_role_authority` VALUES ('2102', '1', '129', '1', 'admin', 'admin', '2020-10-27 08:33:16', '2020-10-27 08:33:16');
INSERT INTO `st_role_authority` VALUES ('2103', '1', '2', '1', 'admin', 'admin', '2020-10-27 08:33:16', '2020-10-27 08:33:16');
INSERT INTO `st_role_authority` VALUES ('2104', '1', '130', '1', 'admin', 'admin', '2020-10-27 08:33:16', '2020-10-27 08:33:16');
INSERT INTO `st_role_authority` VALUES ('2105', '1', '3', '1', 'admin', 'admin', '2020-10-27 08:33:16', '2020-10-27 08:33:16');
INSERT INTO `st_role_authority` VALUES ('2106', '1', '131', '1', 'admin', 'admin', '2020-10-27 08:33:16', '2020-10-27 08:33:16');
INSERT INTO `st_role_authority` VALUES ('2107', '1', '4', '1', 'admin', 'admin', '2020-10-27 08:33:16', '2020-10-27 08:33:16');
INSERT INTO `st_role_authority` VALUES ('2108', '1', '132', '1', 'admin', 'admin', '2020-10-27 08:33:16', '2020-10-27 08:33:16');
INSERT INTO `st_role_authority` VALUES ('2109', '1', '5', '1', 'admin', 'admin', '2020-10-27 08:33:16', '2020-10-27 08:33:16');
INSERT INTO `st_role_authority` VALUES ('2110', '1', '133', '1', 'admin', 'admin', '2020-10-27 08:33:16', '2020-10-27 08:33:16');
INSERT INTO `st_role_authority` VALUES ('2111', '1', '6', '1', 'admin', 'admin', '2020-10-27 08:33:16', '2020-10-27 08:33:16');
INSERT INTO `st_role_authority` VALUES ('2112', '1', '134', '1', 'admin', 'admin', '2020-10-27 08:33:16', '2020-10-27 08:33:16');
INSERT INTO `st_role_authority` VALUES ('2113', '1', '7', '1', 'admin', 'admin', '2020-10-27 08:33:16', '2020-10-27 08:33:16');
INSERT INTO `st_role_authority` VALUES ('2114', '1', '135', '1', 'admin', 'admin', '2020-10-27 08:33:16', '2020-10-27 08:33:16');
INSERT INTO `st_role_authority` VALUES ('2115', '1', '8', '1', 'admin', 'admin', '2020-10-27 08:33:16', '2020-10-27 08:33:16');
INSERT INTO `st_role_authority` VALUES ('2116', '1', '9', '1', 'admin', 'admin', '2020-10-27 08:33:16', '2020-10-27 08:33:16');
INSERT INTO `st_role_authority` VALUES ('2117', '1', '10', '1', 'admin', 'admin', '2020-10-27 08:33:16', '2020-10-27 08:33:16');
INSERT INTO `st_role_authority` VALUES ('2118', '1', '11', '1', 'admin', 'admin', '2020-10-27 08:33:16', '2020-10-27 08:33:16');
INSERT INTO `st_role_authority` VALUES ('2119', '1', '12', '1', 'admin', 'admin', '2020-10-27 08:33:16', '2020-10-27 08:33:16');
INSERT INTO `st_role_authority` VALUES ('2120', '1', '13', '1', 'admin', 'admin', '2020-10-27 08:33:16', '2020-10-27 08:33:16');
INSERT INTO `st_role_authority` VALUES ('2121', '1', '14', '1', 'admin', 'admin', '2020-10-27 08:33:16', '2020-10-27 08:33:16');
INSERT INTO `st_role_authority` VALUES ('2122', '1', '15', '1', 'admin', 'admin', '2020-10-27 08:33:16', '2020-10-27 08:33:16');
INSERT INTO `st_role_authority` VALUES ('2123', '1', '16', '1', 'admin', 'admin', '2020-10-27 08:33:16', '2020-10-27 08:33:16');
INSERT INTO `st_role_authority` VALUES ('2124', '1', '17', '1', 'admin', 'admin', '2020-10-27 08:33:16', '2020-10-27 08:33:16');
INSERT INTO `st_role_authority` VALUES ('2125', '1', '18', '1', 'admin', 'admin', '2020-10-27 08:33:16', '2020-10-27 08:33:16');
INSERT INTO `st_role_authority` VALUES ('2126', '1', '56', '1', 'admin', 'admin', '2020-10-27 08:33:16', '2020-10-27 08:33:16');
INSERT INTO `st_role_authority` VALUES ('2127', '1', '57', '1', 'admin', 'admin', '2020-10-27 08:33:16', '2020-10-27 08:33:16');
INSERT INTO `st_role_authority` VALUES ('2128', '1', '58', '1', 'admin', 'admin', '2020-10-27 08:33:16', '2020-10-27 08:33:16');
INSERT INTO `st_role_authority` VALUES ('2129', '1', '59', '1', 'admin', 'admin', '2020-10-27 08:33:16', '2020-10-27 08:33:16');
INSERT INTO `st_role_authority` VALUES ('2130', '1', '60', '1', 'admin', 'admin', '2020-10-27 08:33:16', '2020-10-27 08:33:16');
INSERT INTO `st_role_authority` VALUES ('2131', '1', '61', '1', 'admin', 'admin', '2020-10-27 08:33:16', '2020-10-27 08:33:16');
INSERT INTO `st_role_authority` VALUES ('2132', '1', '62', '1', 'admin', 'admin', '2020-10-27 08:33:16', '2020-10-27 08:33:16');
INSERT INTO `st_role_authority` VALUES ('2133', '1', '63', '1', 'admin', 'admin', '2020-10-27 08:33:16', '2020-10-27 08:33:16');
INSERT INTO `st_role_authority` VALUES ('2134', '1', '64', '1', 'admin', 'admin', '2020-10-27 08:33:16', '2020-10-27 08:33:16');
INSERT INTO `st_role_authority` VALUES ('2135', '1', '65', '1', 'admin', 'admin', '2020-10-27 08:33:16', '2020-10-27 08:33:16');
INSERT INTO `st_role_authority` VALUES ('2136', '1', '66', '1', 'admin', 'admin', '2020-10-27 08:33:16', '2020-10-27 08:33:16');
INSERT INTO `st_role_authority` VALUES ('2137', '1', '67', '1', 'admin', 'admin', '2020-10-27 08:33:16', '2020-10-27 08:33:16');
INSERT INTO `st_role_authority` VALUES ('2138', '1', '107', '1', 'admin', 'admin', '2020-10-27 08:33:16', '2020-10-27 08:33:16');
INSERT INTO `st_role_authority` VALUES ('2139', '1', '108', '1', 'admin', 'admin', '2020-10-27 08:33:16', '2020-10-27 08:33:16');
INSERT INTO `st_role_authority` VALUES ('2140', '1', '109', '1', 'admin', 'admin', '2020-10-27 08:33:16', '2020-10-27 08:33:16');
INSERT INTO `st_role_authority` VALUES ('2141', '1', '110', '1', 'admin', 'admin', '2020-10-27 08:33:16', '2020-10-27 08:33:16');
INSERT INTO `st_role_authority` VALUES ('2142', '1', '111', '1', 'admin', 'admin', '2020-10-27 08:33:16', '2020-10-27 08:33:16');
INSERT INTO `st_role_authority` VALUES ('2143', '1', '112', '1', 'admin', 'admin', '2020-10-27 08:33:16', '2020-10-27 08:33:16');
INSERT INTO `st_role_authority` VALUES ('2144', '1', '113', '1', 'admin', 'admin', '2020-10-27 08:33:16', '2020-10-27 08:33:16');
INSERT INTO `st_role_authority` VALUES ('2145', '1', '114', '1', 'admin', 'admin', '2020-10-27 08:33:16', '2020-10-27 08:33:16');
INSERT INTO `st_role_authority` VALUES ('2146', '1', '123', '1', 'admin', 'admin', '2020-10-27 08:33:16', '2020-10-27 08:33:16');
INSERT INTO `st_role_authority` VALUES ('2147', '1', '124', '1', 'admin', 'admin', '2020-10-27 08:33:16', '2020-10-27 08:33:16');
INSERT INTO `st_role_authority` VALUES ('2148', '1', '125', '1', 'admin', 'admin', '2020-10-27 08:33:16', '2020-10-27 08:33:16');
INSERT INTO `st_role_authority` VALUES ('2149', '1', '126', '1', 'admin', 'admin', '2020-10-27 08:33:16', '2020-10-27 08:33:16');
INSERT INTO `st_role_authority` VALUES ('2150', '1', '127', '1', 'admin', 'admin', '2020-10-27 08:33:16', '2020-10-27 08:33:16');
...
CREATE TABLE `sys_dict_group` (
  ...
  `del_flag` char(1) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COMMENT='字典分组';
...
-- Records of test_car
-- ----------------------------
INSERT INTO `test_car` VALUES ('1', '奔驰', '1', '1', null, null, null, null, '0', '00000000');
INSERT INTO `test_car` VALUES ('2', '宝马', '666', '', 'admin', '2020-10-27 03:44:37', null, null, '0', '00000000');
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COMMENT='数据字典';

-- ----------------------------
-- Records of test_car_model
-- ----------------------------
INSERT INTO `test_car_model` VALUES ('1', '1', '奔驰007', '007', '1', '1', null, null, null, null, '0');
...
INSERT INTO `test_expand_table` VALUES ('2', '1', '1', '1', '1', '1', '1', '2020-10-27 08:34:40', null, null, null, '0', 'admin', null, '00000000', '1');
