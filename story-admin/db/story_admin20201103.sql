...
CREATE TABLE `st_authority` (
  ...
  `modified_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=181 DEFAULT CHARSET=utf8 COLLATE=utf8_bin ROW_FORMAT=DYNAMIC COMMENT='权限表';
...
INSERT INTO `st_authority` VALUES ('175', '根据用户编号获取详细信息', 'sysmgr.user.query', '0-2-173', null, '2', '173', '1', 'admin', 'admin', '2020-11-03 01:50:54', '2020-11-03 01:50:54');
...
CREATE TABLE `st_login_log` (
  ...
  `modified_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1321344106551652384 DEFAULT CHARSET=utf8 COLLATE=utf8_bin ROW_FORMAT=DYNAMIC COMMENT='登录日志';
...
CREATE TABLE `st_resource` (
  ...
  `modified_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=40 DEFAULT CHARSET=utf8 COLLATE=utf8_bin ROW_FORMAT=DYNAMIC COMMENT='菜单表';
...
CREATE TABLE `st_role_authority` (
  ...
  `modified_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=3310 DEFAULT CHARSET=utf8 COLLATE=utf8_bin ROW_FORMAT=DYNAMIC COMMENT='角色权限关系表';
...
INSERT INTO `st_role_authority` VALUES ('3264', '1', '0', '1', 'admin', 'admin', '2020-11-03 02:39:12', '2020-11-03 02:39:12');
INSERT INTO `st_role_authority` VALUES ('3265', '1', '1', '1', 'admin', 'admin', '2020-11-03 02:39:12', '2020-11-03 02:39:12');
INSERT INTO `st_role_authority` VALUES ('3266', '1', '2', '1', 'admin', 'admin', '2020-11-03 02:39:12', '2020-11-03 02:39:12');
INSERT INTO `st_role_authority` VALUES ('3267', '1', '66', '1', 'admin', 'admin', '2020-11-03 02:39:12', '2020-11-03 02:39:12');
INSERT INTO `st_role_authority` VALUES ('3268', '1', '3', '1', 'admin', 'admin', '2020-11-03 02:39:12', '2020-11-03 02:39:12');
INSERT INTO `st_role_authority` VALUES ('3269', '1', '67', '1', 'admin', 'admin', '2020-11-03 02:39:12', '2020-11-03 02:39:12');
INSERT INTO `st_role_authority` VALUES ('3270', '1', '4', '1', 'admin', 'admin', '2020-11-03 02:39:12', '2020-11-03 02:39:12');
INSERT INTO `st_role_authority` VALUES ('3271', '1', '5', '1', 'admin', 'admin', '2020-11-03 02:39:12', '2020-11-03 02:39:12');
INSERT INTO `st_role_authority` VALUES ('3272', '1', '6', '1', 'admin', 'admin', '2020-11-03 02:39:12', '2020-11-03 02:39:12');
INSERT INTO `st_role_authority` VALUES ('3273', '1', '7', '1', 'admin', 'admin', '2020-11-03 02:39:12', '2020-11-03 02:39:12');
INSERT INTO `st_role_authority` VALUES ('3274', '1', '8', '1', 'admin', 'admin', '2020-11-03 02:39:12', '2020-11-03 02:39:12');
INSERT INTO `st_role_authority` VALUES ('3275', '1', '9', '1', 'admin', 'admin', '2020-11-03 02:39:12', '2020-11-03 02:39:12');
INSERT INTO `st_role_authority` VALUES ('3276', '1', '10', '1', 'admin', 'admin', '2020-11-03 02:39:12', '2020-11-03 02:39:12');
INSERT INTO `st_role_authority` VALUES ('3277', '1', '11', '1', 'admin', 'admin', '2020-11-03 02:39:12', '2020-11-03 02:39:12');
INSERT INTO `st_role_authority` VALUES ('3278', '1', '12', '1', 'admin', 'admin', '2020-11-03 02:39:12', '2020-11-03 02:39:12');
INSERT INTO `st_role_authority` VALUES ('3279', '1', '13', '1', 'admin', 'admin', '2020-11-03 02:39:12', '2020-11-03 02:39:12');
INSERT INTO `st_role_authority` VALUES ('3280', '1', '14', '1', 'admin', 'admin', '2020-11-03 02:39:12', '2020-11-03 02:39:12');
INSERT INTO `st_role_authority` VALUES ('3281', '1', '15', '1', 'admin', 'admin', '2020-11-03 02:39:12', '2020-11-03 02:39:12');
INSERT INTO `st_role_authority` VALUES ('3282', '1', '16', '1', 'admin', 'admin', '2020-11-03 02:39:12', '2020-11-03 02:39:12');
INSERT INTO `st_role_authority` VALUES ('3283', '1', '17', '1', 'admin', 'admin', '2020-11-03 02:39:12', '2020-11-03 02:39:12');
INSERT INTO `st_role_authority` VALUES ('3284', '1', '18', '1', 'admin', 'admin', '2020-11-03 02:39:12', '2020-11-03 02:39:12');
INSERT INTO `st_role_authority` VALUES ('3285', '1', '161', '1', 'admin', 'admin', '2020-11-03 02:39:12', '2020-11-03 02:39:12');
INSERT INTO `st_role_authority` VALUES ('3286', '1', '162', '1', 'admin', 'admin', '2020-11-03 02:39:12', '2020-11-03 02:39:12');
INSERT INTO `st_role_authority` VALUES ('3287', '1', '163', '1', 'admin', 'admin', '2020-11-03 02:39:12', '2020-11-03 02:39:12');
INSERT INTO `st_role_authority` VALUES ('3288', '1', '164', '1', 'admin', 'admin', '2020-11-03 02:39:12', '2020-11-03 02:39:12');
INSERT INTO `st_role_authority` VALUES ('3289', '1', '165', '1', 'admin', 'admin', '2020-11-03 02:39:12', '2020-11-03 02:39:12');
INSERT INTO `st_role_authority` VALUES ('3290', '1', '166', '1', 'admin', 'admin', '2020-11-03 02:39:12', '2020-11-03 02:39:12');
INSERT INTO `st_role_authority` VALUES ('3291', '1', '167', '1', 'admin', 'admin', '2020-11-03 02:39:12', '2020-11-03 02:39:12');
INSERT INTO `st_role_authority` VALUES ('3292', '1', '168', '1', 'admin', 'admin', '2020-11-03 02:39:12', '2020-11-03 02:39:12');
INSERT INTO `st_role_authority` VALUES ('3293', '1', '169', '1', 'admin', 'admin', '2020-11-03 02:39:12', '2020-11-03 02:39:12');
INSERT INTO `st_role_authority` VALUES ('3294', '1', '170', '1', 'admin', 'admin', '2020-11-03 02:39:12', '2020-11-03 02:39:12');
INSERT INTO `st_role_authority` VALUES ('3295', '1', '171', '1', 'admin', 'admin', '2020-11-03 02:39:12', '2020-11-03 02:39:12');
INSERT INTO `st_role_authority` VALUES ('3296', '1', '172', '1', 'admin', 'admin', '2020-11-03 02:39:12', '2020-11-03 02:39:12');
INSERT INTO `st_role_authority` VALUES ('3297', '1', '173', '1', 'admin', 'admin', '2020-11-03 02:39:12', '2020-11-03 02:39:12');
INSERT INTO `st_role_authority` VALUES ('3298', '1', '174', '1', 'admin', 'admin', '2020-11-03 02:39:12', '2020-11-03 02:39:12');
INSERT INTO `st_role_authority` VALUES ('3299', '1', '175', '1', 'admin', 'admin', '2020-11-03 02:39:12', '2020-11-03 02:39:12');
INSERT INTO `st_role_authority` VALUES ('3300', '1', '176', '1', 'admin', 'admin', '2020-11-03 02:39:12', '2020-11-03 02:39:12');
INSERT INTO `st_role_authority` VALUES ('3301', '1', '177', '1', 'admin', 'admin', '2020-11-03 02:39:12', '2020-11-03 02:39:12');
INSERT INTO `st_role_authority` VALUES ('3302', '1', '179', '1', 'admin', 'admin', '2020-11-03 02:39:12', '2020-11-03 02:39:12');
INSERT INTO `st_role_authority` VALUES ('3303', '1', '180', '1', 'admin', 'admin', '2020-11-03 02:39:12', '2020-11-03 02:39:12');
INSERT INTO `st_role_authority` VALUES ('3304', '1', '56', '1', 'admin', 'admin', '2020-11-03 02:39:12', '2020-11-03 02:39:12');
INSERT INTO `st_role_authority` VALUES ('3305', '1', '57', '1', 'admin', 'admin', '2020-11-03 02:39:12', '2020-11-03 02:39:12');
INSERT INTO `st_role_authority` VALUES ('3306', '1', '58', '1', 'admin', 'admin', '2020-11-03 02:39:12', '2020-11-03 02:39:12');
INSERT INTO `st_role_authority` VALUES ('3307', '1', '59', '1', 'admin', 'admin', '2020-11-03 02:39:12', '2020-11-03 02:39:12');
INSERT INTO `st_role_authority` VALUES ('3308', '1', '60', '1', 'admin', 'admin', '2020-11-03 02:39:12', '2020-11-03 02:39:12');
INSERT INTO `st_role_authority` VALUES ('3309', '1', '61', '1', 'admin', 'admin', '2020-11-03 02:39:12', '2020-11-03 02:39:12');
