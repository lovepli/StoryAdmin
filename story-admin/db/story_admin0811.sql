...
CREATE TABLE `st_attachment`  (
  ...
  `uploader` bigint(0) NOT NULL,
  `STATUS` decimal(2, 0) NOT NULL DEFAULT 1 COMMENT '1 正常 0 已被删除',
  `deleter` bigint(0) NULL DEFAULT NULL,
...
CREATE TABLE `st_authority`  (
  ...
  `show_order` int(0) NULL DEFAULT NULL COMMENT '排序',
  ...
  `modified_time` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 62 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '权限表' ROW_FORMAT = Dynamic;
...
INSERT INTO `st_authority` VALUES (57, '查询公告', 'sysmgr.inform.query', '0-2-56', NULL, 1, 56, '1', 'admin', 'admin', '2020-08-11 08:47:25', '2020-08-11 08:47:25');
INSERT INTO `st_authority` VALUES (58, '查看公告详情', 'sysmgr.inform.query', '0-2-56', NULL, 2, 56, '1', 'admin', 'admin', '2020-08-11 08:48:13', '2020-08-11 08:48:13');
...
INSERT INTO `st_authority` VALUES (60, '置顶公告', 'sysmgr.inform.top', '0-2-56', NULL, 4, 56, '1', 'admin', 'admin', '2020-08-11 08:49:32', '2020-08-11 08:49:32');
INSERT INTO `st_authority` VALUES (61, '取消公告的置顶', 'sysmgr.inform.untop', '0-2-56', NULL, 5, 56, '1', 'admin', 'admin', '2020-08-11 08:50:05', '2020-08-11 08:50:05');
...
CREATE TABLE `st_backup`  (
  ...
  `runtime` bigint(0) NULL DEFAULT NULL,
...
INSERT INTO `st_dept` VALUES (4, '销售部门', 0, 4, NULL, '1', 'admin', 'admin', '2020-07-31 08:31:00', '2020-07-31 08:31:00');
...
CREATE TABLE `st_inform`  (
  ...
  `canceler` bigint(0) NULL DEFAULT NULL COMMENT '撤销人ID',
  `cancel_date` datetime(0) NULL DEFAULT NULL COMMENT '撤销时间',
  `outdate_operator` bigint(0) NULL DEFAULT NULL COMMENT '过期操作人ID',
...
-- ----------------------------
INSERT INTO `st_inform` VALUES (1, '11', 1, 1, '11', '', NULL, NULL, NULL, NULL, '2020-08-11 09:21:35', 1);
INSERT INTO `st_inform` VALUES (2, '22', 1, 1, '22', '', NULL, NULL, NULL, NULL, '2020-08-11 09:23:41', 1);
INSERT INTO `st_inform` VALUES (3, '11', 0, 1, '11', '', NULL, NULL, NULL, NULL, '2020-08-11 09:25:16', NULL);
INSERT INTO `st_inform` VALUES (4, '11', 1, 1, '11', '', NULL, NULL, NULL, NULL, '2020-08-11 09:25:28', NULL);
INSERT INTO `st_inform` VALUES (5, '22', 1, 1, '222', '', NULL, NULL, NULL, NULL, '2020-08-11 09:29:17', NULL);
INSERT INTO `st_inform` VALUES (6, '22', 0, 1, '2222222', '', NULL, NULL, NULL, NULL, '2020-08-11 09:29:59', NULL);
...
CREATE TABLE `st_login_log`  (
  ...
  `modified_time` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 98 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '登录日志' ROW_FORMAT = Dynamic;
...
CREATE TABLE `st_role_authority`  (
  ...
  `modified_time` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 384 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '角色权限关系表' ROW_FORMAT = Dynamic;
...
INSERT INTO `st_role_authority` VALUES (333, 1, 0, '1', 'admin', 'admin', '2020-08-11 08:59:38', '2020-08-11 08:59:38');
INSERT INTO `st_role_authority` VALUES (334, 1, 1, '1', 'admin', 'admin', '2020-08-11 08:59:38', '2020-08-11 08:59:38');
INSERT INTO `st_role_authority` VALUES (335, 1, 2, '1', 'admin', 'admin', '2020-08-11 08:59:38', '2020-08-11 08:59:38');
INSERT INTO `st_role_authority` VALUES (336, 1, 3, '1', 'admin', 'admin', '2020-08-11 08:59:38', '2020-08-11 08:59:38');
INSERT INTO `st_role_authority` VALUES (337, 1, 4, '1', 'admin', 'admin', '2020-08-11 08:59:38', '2020-08-11 08:59:38');
INSERT INTO `st_role_authority` VALUES (338, 1, 5, '1', 'admin', 'admin', '2020-08-11 08:59:38', '2020-08-11 08:59:38');
INSERT INTO `st_role_authority` VALUES (339, 1, 6, '1', 'admin', 'admin', '2020-08-11 08:59:38', '2020-08-11 08:59:38');
INSERT INTO `st_role_authority` VALUES (340, 1, 7, '1', 'admin', 'admin', '2020-08-11 08:59:38', '2020-08-11 08:59:38');
INSERT INTO `st_role_authority` VALUES (341, 1, 8, '1', 'admin', 'admin', '2020-08-11 08:59:38', '2020-08-11 08:59:38');
INSERT INTO `st_role_authority` VALUES (342, 1, 9, '1', 'admin', 'admin', '2020-08-11 08:59:38', '2020-08-11 08:59:38');
INSERT INTO `st_role_authority` VALUES (343, 1, 10, '1', 'admin', 'admin', '2020-08-11 08:59:38', '2020-08-11 08:59:38');
INSERT INTO `st_role_authority` VALUES (344, 1, 11, '1', 'admin', 'admin', '2020-08-11 08:59:38', '2020-08-11 08:59:38');
INSERT INTO `st_role_authority` VALUES (345, 1, 12, '1', 'admin', 'admin', '2020-08-11 08:59:38', '2020-08-11 08:59:38');
INSERT INTO `st_role_authority` VALUES (346, 1, 13, '1', 'admin', 'admin', '2020-08-11 08:59:38', '2020-08-11 08:59:38');
INSERT INTO `st_role_authority` VALUES (347, 1, 14, '1', 'admin', 'admin', '2020-08-11 08:59:38', '2020-08-11 08:59:38');
INSERT INTO `st_role_authority` VALUES (348, 1, 15, '1', 'admin', 'admin', '2020-08-11 08:59:38', '2020-08-11 08:59:38');
INSERT INTO `st_role_authority` VALUES (349, 1, 16, '1', 'admin', 'admin', '2020-08-11 08:59:38', '2020-08-11 08:59:38');
INSERT INTO `st_role_authority` VALUES (350, 1, 17, '1', 'admin', 'admin', '2020-08-11 08:59:38', '2020-08-11 08:59:38');
INSERT INTO `st_role_authority` VALUES (351, 1, 18, '1', 'admin', 'admin', '2020-08-11 08:59:38', '2020-08-11 08:59:38');
INSERT INTO `st_role_authority` VALUES (352, 1, 30, '1', 'admin', 'admin', '2020-08-11 08:59:38', '2020-08-11 08:59:38');
INSERT INTO `st_role_authority` VALUES (353, 1, 31, '1', 'admin', 'admin', '2020-08-11 08:59:38', '2020-08-11 08:59:38');
INSERT INTO `st_role_authority` VALUES (354, 1, 32, '1', 'admin', 'admin', '2020-08-11 08:59:38', '2020-08-11 08:59:38');
INSERT INTO `st_role_authority` VALUES (355, 1, 33, '1', 'admin', 'admin', '2020-08-11 08:59:38', '2020-08-11 08:59:38');
INSERT INTO `st_role_authority` VALUES (356, 1, 34, '1', 'admin', 'admin', '2020-08-11 08:59:38', '2020-08-11 08:59:38');
INSERT INTO `st_role_authority` VALUES (357, 1, 35, '1', 'admin', 'admin', '2020-08-11 08:59:38', '2020-08-11 08:59:38');
INSERT INTO `st_role_authority` VALUES (358, 1, 36, '1', 'admin', 'admin', '2020-08-11 08:59:38', '2020-08-11 08:59:38');
INSERT INTO `st_role_authority` VALUES (359, 1, 37, '1', 'admin', 'admin', '2020-08-11 08:59:38', '2020-08-11 08:59:38');
INSERT INTO `st_role_authority` VALUES (360, 1, 38, '1', 'admin', 'admin', '2020-08-11 08:59:38', '2020-08-11 08:59:38');
INSERT INTO `st_role_authority` VALUES (361, 1, 39, '1', 'admin', 'admin', '2020-08-11 08:59:38', '2020-08-11 08:59:38');
INSERT INTO `st_role_authority` VALUES (362, 1, 40, '1', 'admin', 'admin', '2020-08-11 08:59:38', '2020-08-11 08:59:38');
INSERT INTO `st_role_authority` VALUES (363, 1, 41, '1', 'admin', 'admin', '2020-08-11 08:59:38', '2020-08-11 08:59:38');
INSERT INTO `st_role_authority` VALUES (364, 1, 42, '1', 'admin', 'admin', '2020-08-11 08:59:38', '2020-08-11 08:59:38');
INSERT INTO `st_role_authority` VALUES (365, 1, 43, '1', 'admin', 'admin', '2020-08-11 08:59:38', '2020-08-11 08:59:38');
INSERT INTO `st_role_authority` VALUES (366, 1, 44, '1', 'admin', 'admin', '2020-08-11 08:59:38', '2020-08-11 08:59:38');
INSERT INTO `st_role_authority` VALUES (367, 1, 45, '1', 'admin', 'admin', '2020-08-11 08:59:38', '2020-08-11 08:59:38');
INSERT INTO `st_role_authority` VALUES (368, 1, 46, '1', 'admin', 'admin', '2020-08-11 08:59:38', '2020-08-11 08:59:38');
INSERT INTO `st_role_authority` VALUES (369, 1, 47, '1', 'admin', 'admin', '2020-08-11 08:59:38', '2020-08-11 08:59:38');
INSERT INTO `st_role_authority` VALUES (370, 1, 48, '1', 'admin', 'admin', '2020-08-11 08:59:38', '2020-08-11 08:59:38');
INSERT INTO `st_role_authority` VALUES (371, 1, 49, '1', 'admin', 'admin', '2020-08-11 08:59:38', '2020-08-11 08:59:38');
INSERT INTO `st_role_authority` VALUES (372, 1, 50, '1', 'admin', 'admin', '2020-08-11 08:59:38', '2020-08-11 08:59:38');
INSERT INTO `st_role_authority` VALUES (373, 1, 51, '1', 'admin', 'admin', '2020-08-11 08:59:38', '2020-08-11 08:59:38');
INSERT INTO `st_role_authority` VALUES (374, 1, 52, '1', 'admin', 'admin', '2020-08-11 08:59:38', '2020-08-11 08:59:38');
INSERT INTO `st_role_authority` VALUES (375, 1, 53, '1', 'admin', 'admin', '2020-08-11 08:59:38', '2020-08-11 08:59:38');
INSERT INTO `st_role_authority` VALUES (376, 1, 54, '1', 'admin', 'admin', '2020-08-11 08:59:38', '2020-08-11 08:59:38');
INSERT INTO `st_role_authority` VALUES (377, 1, 55, '1', 'admin', 'admin', '2020-08-11 08:59:38', '2020-08-11 08:59:38');
INSERT INTO `st_role_authority` VALUES (378, 1, 56, '1', 'admin', 'admin', '2020-08-11 08:59:38', '2020-08-11 08:59:38');
INSERT INTO `st_role_authority` VALUES (379, 1, 57, '1', 'admin', 'admin', '2020-08-11 08:59:38', '2020-08-11 08:59:38');
INSERT INTO `st_role_authority` VALUES (380, 1, 58, '1', 'admin', 'admin', '2020-08-11 08:59:38', '2020-08-11 08:59:38');
INSERT INTO `st_role_authority` VALUES (381, 1, 59, '1', 'admin', 'admin', '2020-08-11 08:59:38', '2020-08-11 08:59:38');
INSERT INTO `st_role_authority` VALUES (382, 1, 60, '1', 'admin', 'admin', '2020-08-11 08:59:38', '2020-08-11 08:59:38');
INSERT INTO `st_role_authority` VALUES (383, 1, 61, '1', 'admin', 'admin', '2020-08-11 08:59:38', '2020-08-11 08:59:38');
...
-- ----------------------------
INSERT INTO `st_schedule_job` VALUES (1, 'StoryDemoJob', '框架演示任务', '0 0/5 * * * ?', b'1', 'com.story.storyadmin.scheduler.StoryDemoJob', '2019-08-19 06:14:06', '2020-08-11 09:40:00', '2020-08-11 09:35:00', '2020-08-11 09:45:00', '演示，仅此而已', NULL, '1', 'admin', 'admin', '2019-08-19 06:14:20', '2020-08-11 09:40:00');
...
CREATE TABLE `st_todo`  (
  ...
  `days_count` int(0) NULL DEFAULT NULL COMMENT '天数',
  `url` varchar(64) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '链接',
