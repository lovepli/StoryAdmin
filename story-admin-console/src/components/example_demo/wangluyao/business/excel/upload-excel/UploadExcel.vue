<template>
  <div class="excel-upload">
    <input ref="fileInput" style="display:none" type="file" accept=".xlsx,.xls" @change="selectFile">
    <el-button :loading="loading" type="info" round icon="el-icon-upload" @click="handleUpload">点击选择文件</el-button>
    <span v-show="fileName" class="file-name">
