      ...
      <div style="min-height:60vh">
        <row :gutter="16">
          <el-col :span="16">
            <el-form ref="form" :model="form" label-width="130px">
              <el-form-item label="SMTP服务器地址">
                <el-input v-model="form.email_host"/>
              </el-form-item>
              <el-form-item label="邮件协议形式">
                <el-input v-model="form.email_smtp_label"/>
              </el-form-item>
              ...
              <el-form-item label="发件邮箱">
                <el-input v-model="form.email_num"/>
              </el-form-item>
              <el-form-item label="邮箱授权码">
                <el-input v-model="form.eamil_empower_code" show-password/>
              </el-form-item>
              <el-form-item label="发件人名称">
                <el-input v-model="form.email_send_user_name"/>
              </el-form-item>
              <el-form-item label="回复收件箱">
                <el-input v-model="form.email_address_email"/>
              </el-form-item>
              <div align="center">
          ...
          <el-col :span="8" align="center">
            <i id="email" class="el-icon-message" title="邮件测试" @click="dialog_visible_state=true"/>
            <el-dialog
            ...
            >
              <el-form ref="form" :model="send_form" label-width="80px">
                <el-form-item label="收件箱">
                  <el-input v-model="send_form.to_email"/>
                </el-form-item>
                <el-form-item label="邮件标题">
                  <el-input v-model="send_form.to_email_title"/>
                </el-form-item>
                <el-form-item label="邮件内容">
                  <el-input :rows="2" v-model="send_form.to_email_content" type="textarea"/>
                </el-form-item>
                <el-form-item>
