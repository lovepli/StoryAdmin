    ...
    <el-card shadow="never" style="min-height:70vh">
      ...
      <el-form ref="form" :model="form" label-width="80px">
        ...
        <el-form-item label="数字">
          <el-input-number v-model="form.input_num" :min="1" :max="1000" label="数值"/>
        </el-form-item>
        ...
        <el-form-item label="文本框">
          <el-input :rows="5" v-model="form.textarea" type="textarea" placeholder="请输入内容"/>
        </el-form-item>
        <el-form-item label="富文本">
          <EditorSpace v-model="form.editor" />
        </el-form-item>
      </el-form>
      <div align="center">
