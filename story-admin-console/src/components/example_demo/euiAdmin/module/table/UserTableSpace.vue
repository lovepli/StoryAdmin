    ...
    <el-card shadow="never" class="card">
      ...
      <div id="charts_one" style="width:100%;min-height:300px">
        ...
        >
          ...
          <el-table-column property="user_pet_name" label="用户昵称"/>
          <el-table-column property="user_name" label="用户名"/>
          <el-table-column property="user_email" label="用户邮箱"/>
          <el-table-column property="user_phone" label="用户电话"/>
          <el-table-column property="user_age" label="用户年龄"/>
    ...
    <el-dialog :title="dialog_title" :visible.sync="dialog_viside_state">
      <el-form ref="form" :model="user_form" label-width="80px">
        <el-form-item label="用户昵称">
          <el-input v-model="user_form.user_pet_name" placeholder="请输入用户昵称"/>
        </el-form-item>
        <el-form-item label="用户名">
          <el-input v-model="user_form.user_name" placeholder="请输入用户名"/>
        </el-form-item>
        <el-form-item v-show="password_input_state" label="用户密码">
          <el-input v-model="user_form.user_password" show-password placeholder="请输入用户密码"/>
        </el-form-item>
        <el-form-item label="用户邮箱">
          <el-input v-model="user_form.user_email" placeholder="请输入用户邮箱"/>
        </el-form-item>
        <el-form-item label="用户电话">
          <el-input v-model="user_form.user_phone" placeholder="请输入用户电话"/>
        </el-form-item>
        <el-form-item label="用户年纪">
          <el-input-number v-model="user_form.user_age" :min="1" :max="200" label="描述文字"/>
        </el-form-item>
        ...
        <div align="center">
          <el-button v-show="!password_input_state" type="danger" size="small" @click="editor">确认修改</el-button>
          <el-button
