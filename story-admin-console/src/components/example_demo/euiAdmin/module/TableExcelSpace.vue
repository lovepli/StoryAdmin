...
export default {
  components: {
    ImportExcel: resolve => { require(['@/components/example_demo/euiAdmin/module/excel/ImportExcel.vue'], resolve) },
    OutEXcel: resolve => { require(['@/components/example_demo/euiAdmin/module/excel/OutEXcel.vue'], resolve) }
  },
  data() {
    return {
