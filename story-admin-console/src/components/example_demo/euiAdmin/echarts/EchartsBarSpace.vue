    ...
    <el-row :gutter="20">
      <el-col :span="12">
        <el-card shadow="never" class="card">
          ...
          <div id="charts_one" style="width:100%;height:300px"/>
        </el-card>
      </el-col>
      <el-col :span="12">
        <el-card shadow="never" class="card">
          ...
          <div id="charts_two" style="width:100%;height:300px"/>
        </el-card>
      </el-col>
    </el-row>
    <el-row :gutter="20" style="margin-top:20px">
      <el-col :span="12">
        <el-card shadow="never" class="card">
          ...
          <div id="charts_three" style="width:100%;height:300px"/>
        </el-card>
      </el-col>
      <el-col :span="12">
        <el-card shadow="never" class="card">
          ...
          <div id="charts_four" style="width:100%;height:300px"/>
        </el-card>
      </el-col>
    </el-row>
  </div>
