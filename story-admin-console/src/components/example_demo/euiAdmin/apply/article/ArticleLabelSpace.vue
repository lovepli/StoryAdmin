<template>
  <div>
    <el-card shadow="never" class="card">
      ...
      <el-button :disabled="selection_button_title=='未选择数据'" size="small" type="danger" icon="">{{ selection_button_title }}</el-button>
    ...
    <el-dialog :title="dialog_title" :visible.sync="dialog_viside_state" width="30%">
