...
<template>
  <div class="container">
    <div class="content">
      <canvas id="universe" width="100%" height="100%"/>
    ...
    <div class="login-container">
      ...
      >
        ...
        <el-form-item prop="password">
          ...
          />
          <!-- showPwd 显示密码，也可以用el-input组件中自带的show-password属性即可以得到一个可切换显示隐藏的密码框 -->
...
function Star() {
  ...
  this.fadeIn = function() {
    if (this.fadingIn) {
      ...
      this.fadingIn = !(this.opacity > this.opacityTresh); // 另一种写法
  ...
  this.fadeOut = function() {
    if (this.fadingOut) {
      ...
      this.fadingOut = !(this.opacity < 0); // 另一种写法
  ...
  this.draw = function() {
    const universe = document.getElementById('universe').getContext('2d');
    universe.beginPath();
