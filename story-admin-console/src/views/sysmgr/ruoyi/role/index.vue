...
<script>
import { listRole, getRole, delRole, addRole, updateRole, exportRole, dataScope, changeRoleStatus } from '@/api/ruoyi/role';
import { treeselect as menuTreeselect, roleMenuTreeselect } from '@/api/ruoyi/menu';
import { treeselect as deptTreeselect, roleDeptTreeselect } from '@/api/ruoyi/dept';
