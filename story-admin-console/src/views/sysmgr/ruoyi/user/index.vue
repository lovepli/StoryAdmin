    ...
    <el-row :gutter="20">
      ...
      <el-col :span="20" :xs="24">
        ...
        <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
          ...
          <el-table-column :show-overflow-tooltip="true" label="用户名称" align="center" prop="userName" />
          <el-table-column :show-overflow-tooltip="true" label="用户昵称" align="center" prop="nickName" />
          <el-table-column :show-overflow-tooltip="true" label="部门" align="center" prop="dept.deptName" />
...
import Pagination from '@/components/RuoYi/Pagination'; // 分页组件
import RightToolbar from '@/components/RightToolbar'; // 引入RightToolbar子组件

export default {
  name: 'User',
  components: { Treeselect, Pagination, RightToolbar },
  filters: {
    parseTime
  },
  data() {
  ...
  created() {
    ...
    // });
    this.sexOptions = [{ dictValue: '0', dictLabel: '男' }, { dictValue: '1', dictLabel: '女' }, { dictValue: '2', dictLabel: '未知' }]
