            ...
            <table cellspacing="0" style="width: 100%;">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><div v-if="server.mem" :class="{'text-danger': server.mem.usage > 80}" class="cell">{{ server.mem.usage }}%</div></td>
                  <td><div v-if="server.jvm" :class="{'text-danger': server.jvm.usage > 80}" class="cell">{{ server.jvm.usage }}%</div></td>
                </tr>
              </tbody>
            </table>
          </div>
            ...
            <table cellspacing="0" style="width: 100%;">
              ...
              <tbody v-if="server.sysFiles">
                <tr v-for="sysFile in server.sysFiles">
                  ...
                  <td><div :class="{'text-danger': sysFile.usage > 80}" class="cell">{{ sysFile.usage }}%</div></td>
                </tr>
              </tbody>
            </table>
          </div>
